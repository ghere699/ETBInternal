...
// Function UI_Desktop.UI_Desktop_C.PlayClick
// (BlueprintCallable, BlueprintEvent)

void UUI_Desktop_C::PlayClick()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_Desktop_C", "PlayClick");

	UObject::ProcessEvent(Func, nullptr);
}


// Function UI_Desktop.UI_Desktop_C.RestoreFocus
// (BlueprintCallable, BlueprintEvent)

void UUI_Desktop_C::RestoreFocus()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_Desktop_C", "RestoreFocus");

	UObject::ProcessEvent(Func, nullptr);
}


// Function UI_Desktop.UI_Desktop_C.InitialFocus
// (BlueprintCallable, BlueprintEvent)

void UUI_Desktop_C::InitialFocus()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_Desktop_C", "InitialFocus");
...
void UUI_Desktop_C::AddWidget(class UUI_Drag_C* Widget, const class FText& Text)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UUI_Desktop_C::CustomNavigation(EUINavigation Navigation_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_Desktop_C", "CustomNavigation");

	Params::UI_Desktop_C_CustomNavigation Parms{};
...
void UUI_Desktop_C::GetRowAndColumnForApplication(int32* Row, int32* Column)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_Desktop_C", "GetRowAndColumnForApplication");

	Params::UI_Desktop_C_GetRowAndColumnForApplication Parms{};
...
// class UUI_Drag_C*                       ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

class UUI_Drag_C* UUI_Desktop_C::LaunchProgram(float InMinDesiredWidth, float InMinDesiredHeight, class UWidget* ProgramContent, const struct FVector2D& InPosition, const class FText& InText)
{
	static class UFunction* Func = nullptr;
...
struct FEventReply UUI_Desktop_C::OnKeyDown(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_Desktop_C", "OnKeyDown");

	Params::UI_Desktop_C_OnKeyDown Parms{};
