...
public:
	...
	struct FBPUniqueNetId                         ReturnValue;                                       // 0x0010(0x0028)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FBPUniqueNetId                         TextSourceID;                                      // 0x0018(0x0028)(ConstParm, Parm, NativeAccessSpecifierPublic)
	class FString                                 FilteredText;                                      // 0x0040(0x0010)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0050(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_AdvancedSteamFriendsLibrary_FilterText;
...
public:
	struct FBPUniqueNetId                         UniqueNetId;                                       // 0x0000(0x0028)(ConstParm, Parm, NativeAccessSpecifierPublic)
	EBlueprintAsyncResultSwitch                   Result;                                            // 0x0028(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESteamAvatarSize                              AvatarSize;                                        // 0x0029(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
DUMPER7_ASSERTS_AdvancedSteamFriendsLibrary_InitTextFiltering;
...
DUMPER7_ASSERTS_AdvancedSteamFriendsLibrary_IsOverlayEnabled;
...
DUMPER7_ASSERTS_AdvancedSteamFriendsLibrary_IsSteamInBigPictureMode;
...
public:
	struct FBPUniqueNetId                         UniqueNetId;                                       // 0x0000(0x0028)(ConstParm, Parm, NativeAccessSpecifierPublic)
	ESteamUserOverlayType                         DialogType;                                        // 0x0028(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	struct FBPUniqueNetId                         UniqueNetId;                                       // 0x0000(0x0028)(ConstParm, Parm, NativeAccessSpecifierPublic)
	bool                                          bRequireNameOnly;                                  // 0x0028(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0029(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A[0x6];                                       // 0x002A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	struct FBPUniqueNetId                         GroupUniqueNetID;                                  // 0x0008(0x0028)(Parm, NativeAccessSpecifierPublic)
	class USteamRequestGroupOfficersCallbackProxy* ReturnValue;                                      // 0x0030(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
