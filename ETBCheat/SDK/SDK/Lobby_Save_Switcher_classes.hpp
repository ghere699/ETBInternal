...
public:
	...
	TMulticastInlineDelegate<void(const class FString& SelectedOption)> OnSaveSwitched;              // 0x02B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
