...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// const struct FSteamVRAction&            SteamVRActionHandle                                    (Parm, NativeAccessSpecifierPublic)
// TArray<struct FSteamVRInputBindingInfo> ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const struct FSteamVRAction&            SteamVRAction                                          (Parm, NativeAccessSpecifierPublic)
// const TArray<ESteamVRInputStringBits>&  LocalizedParts                                         (Parm, ZeroConstructor, NativeAccessSpecifierPublic)
...
// Parameters:
// const struct FSteamVRAction&            SteamVRAction                                          (Parm, NativeAccessSpecifierPublic)
// const struct FSteamVRActionSet&         SteamVRActionSet                                       (Parm, NativeAccessSpecifierPublic)
