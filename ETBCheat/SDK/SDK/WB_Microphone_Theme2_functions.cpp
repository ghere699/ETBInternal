...
void UWB_Microphone_Theme2_C::ToggleFocus(bool IsFocused)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_Microphone_Theme2_C", "ToggleFocus");

	Params::WB_Microphone_Theme2_C_ToggleFocus Parms{};
...
void UWB_Microphone_Theme2_C::ToggleEnabled(bool IsEnabled)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_Microphone_Theme2_C", "ToggleEnabled");

	Params::WB_Microphone_Theme2_C_ToggleEnabled Parms{};
...
void UWB_Microphone_Theme2_C::ToggleHover(bool IsHovered_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_Microphone_Theme2_C", "ToggleHover");

	Params::WB_Microphone_Theme2_C_ToggleHover Parms{};
...
struct FEventReply UWB_Microphone_Theme2_C::OnPreviewKeyDown(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_Microphone_Theme2_C", "OnPreviewKeyDown");

	Params::WB_Microphone_Theme2_C_OnPreviewKeyDown Parms{};
